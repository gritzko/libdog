...
//  slot.  The ONE header drawer (`dog/HUNK.c` `HUNKu8sFeedBanner`)
//  references it for every hunk header; bro passes its terminal width so
//  the same drawer space-fills the band to the edge in the pager.
//  256-color (fg 0 = black, bg 230 = pale yellow) so it reads the same
